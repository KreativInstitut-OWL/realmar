...
export const labelVariants = cva(
  "px-2 py-1.5 text-xs font-semibold text-gray-11",
  {
    variants: {
      inset: {
        true: "pl-8",
...
export const radioItemVariants = cva(
  "relative flex cursor-default select-none items-center rounded-xs py-1.5 pl-8 pr-2 text-xs outline-hidden focus:bg-azure-4 focus:text-azure-12 data-disabled:not-[[data-disabled=false]]:pointer-events-none data-disabled:not-[[data-disabled=false]]:opacity-50"
);
...
export const itemVariants = cva(
  "relative flex gap-2 cursor-default select-none items-center text-gray-12 rounded-xs px-2 py-1.5 text-xs outline-hidden focus:bg-azure-4 data-[selected=true]:bg-azure-4 focus:text-azure-12 data-[selected=true]:text-azure-12 data-disabled:not-[[data-disabled=false]]:pointer-events-none data-disabled:not-[[data-disabled=false]]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      inset: {
        true: "pl-8",
...
export const subTriggerVariants = cva(
  "flex cursor-default select-none items-center rounded-xs px-2 py-1.5 text-xs outline-hidden focus:bg-azure-4 focus:text-azure-12 data-[state=open]:bg-azure-4 data-[state=open]:text-azure-12 [&_[data-chevron]]:ml-auto [&_[data-chevron]]:size-4",
  {
    variants: {
      inset: {
        true: "pl-8",
