...
export const shortcutVariants = cva(
  "ml-auto text-sm tracking-widest text-gray-11"
);
...
export const subTriggerVariants = cva(
  "flex gap-2 cursor-default select-none items-center rounded-xs px-2 py-1.5 text-sm outline-hidden focus:bg-azure-4 focus:text-azure-12 data-[state=open]:bg-azure-4 data-[state=open]:text-azure-12 [&_[data-chevron]]:ml-auto [&_[data-chevron]]:size-4 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      inset: {
        true: "pl-8",
