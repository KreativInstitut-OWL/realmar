...
export const contentVariants = cva(
  "z-50 min-w-[8rem] max-h-(--radix-popper-available-height) overflow-y-auto overflow-x-clip rounded-md border border-gray-4 bg-gray-1/70 dark:bg-gray-1/60 backdrop-blur-md p-1 text-gray-12 shadow-md ring-offset-transparent animate-in fade-in-80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-(--radix-popper-transform-origin)"
);
export const subContentVariants = cva(
  "z-50 min-w-[8rem] max-h-(--radix-popper-available-height) overflow-y-auto overflow-x-clip rounded-md border border-gray-4 bg-gray-1/70 dark:bg-gray-1/60 backdrop-blur-md p-1 text-gray-12 shadow-md ring-offset-transparent data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-(--radix-popper-transform-origin)"
);
